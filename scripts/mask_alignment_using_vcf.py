...
# Usage: python ./scripts/mask_alignment_using_vcf.py -i data/raw/all.consensus.wref.aln.fasta -o all.consensus.wref.aln.mask.fasta -v data/reference/problematic_sites_sarsCov2.vcf
