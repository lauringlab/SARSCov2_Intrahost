...
# Usage: python ./scripts/mask_alignment_using_vcf.py -i data/all.consensus.wref2.aln.fasta -o data/all.consensus.wref2.aln.mask.fasta -v data/problematic_sites_sarsCov2.vcf
